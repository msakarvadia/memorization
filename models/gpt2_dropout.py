...
"""
Copy and paste from https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py
Addition of ExampleTiedDropout to GPT2, this needs the whole model since we have to pass
a whole new tensor of inputs as well
"""
...
# get example tied dropout module
from utils.dropout import ExampleTiedDropout
...
class GPT2Block(nn.Module):
    ...
    def forward(
        ...
        use_cache: Optional[bool] = False,
        output_attentions: Optional[bool] = False,
        input_idx=None,  # these input indices are used for example tied dropout, should be of the same shape as X
    ) -> Union[
        Tuple[torch.Tensor],
        Optional[Tuple[torch.Tensor, Tuple[torch.FloatTensor, ...]]],
    ]:
        # dropout hidden states
        # in principle we could do this at several location in this block, but this should
        ...
        if input_idx is None:
            ...
            assert (
                not self.training
            ), "Must provide input_idx in training mode - did you forget to `model.eval()`?"
        ...
        for i, (block, layer_past) in enumerate(zip(self.h, past_key_values)):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                outputs = block(
                    ...
                    use_cache=use_cache,
                    output_attentions=output_attentions,
                    input_idx=input_idx,  # passing input idx
                )
