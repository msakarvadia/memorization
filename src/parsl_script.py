...
run_dir = "/grand/projects/SuperBERT/aswathy/projects/memorization/"

user_opts = {
    "worker_init":      f"module load conda; conda activate memorization; cd {run_dir}", # load the environment where parsl is installed
    "scheduler_options":"#PBS -l filesystems=home:eagle:grand" , # specify any PBS options here, like filesystems
    "account":          "SuperBERT",
    "queue":            "preemptable", #e.g.: "debug, "preemptable" (see https://docs.alcf.anl.gov/polaris/running-jobs/)
    "walltime":         "72:00:00",
...
@bash_app
def generate_completions(model_name="EleutherAI/gpt-neo-125M", path_to_prompts="data/prompts/prompts_100.npy", generations_save_path="/grand/projects/SuperBERT/aswathy/projects/memorization/data/model_generations2/gpt-neo-125M/125M-0.0_prompt_50_of_100.npy", mem_prompt_save_path="data/memorized_prompts/gpt-neo-125M/125M-0.0_mem_50_of_100.npy", stdout='echo-hello.stdout', stderr='echo-hello.stderr'):
