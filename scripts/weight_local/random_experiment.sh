...
#NOTE (MS): I only have a separate experiment script for random because I completed the method a little later than the rest

#TODO vary random HC hyper params
#TODO vary num_layers of the extra data params

result_file=random_weight_result1.csv
